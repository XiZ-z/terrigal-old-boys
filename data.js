...
const RESULTS = {
  ...
  // (randomly simulated, 6 sets/48 games per match) so the site can be
  // shown off with real-looking ladder/records/finals. main stays cleared
  // until actual Round 1 results come in.
  "1-0": { setsA: 3.5, setsB: 2.5, gamesA: 22, gamesB: 26 },
  "1-1": { setsA: 2.5, setsB: 3.5, gamesA: 24, gamesB: 24 },
  "1-2": { setsA: 3.5, setsB: 2.5, gamesA: 26, gamesB: 22 },
  "1-3": { setsA: 5, setsB: 1, gamesA: 34, gamesB: 14 },
  "2-0": { setsA: 3, setsB: 3, gamesA: 22, gamesB: 26 },
  "2-1": { setsA: 2.5, setsB: 3.5, gamesA: 27, gamesB: 21 },
  "2-2": { setsA: 3, setsB: 3, gamesA: 23, gamesB: 25 },
  "2-3": { setsA: 4, setsB: 2, gamesA: 28, gamesB: 20 },
  "3-0": { setsA: 3, setsB: 3, gamesA: 24, gamesB: 24 },
  "3-1": { setsA: 2.5, setsB: 3.5, gamesA: 17, gamesB: 31 },
  "3-2": { setsA: 1.5, setsB: 4.5, gamesA: 14, gamesB: 34 },
  "3-3": { setsA: 2, setsB: 4, gamesA: 21, gamesB: 27 },
  "4-0": { setsA: 3, setsB: 3, gamesA: 18, gamesB: 30 },
  "4-1": { setsA: 3, setsB: 3, gamesA: 24, gamesB: 24 },
  "4-2": { setsA: 1, setsB: 5, gamesA: 17, gamesB: 31 },
  "4-3": { setsA: 2.5, setsB: 3.5, gamesA: 21, gamesB: 27 },
  "5-0": { setsA: 3, setsB: 3, gamesA: 21, gamesB: 27 },
  ...
  "7-0": { setsA: 1, setsB: 5, gamesA: 11, gamesB: 37 },
  "7-1": { setsA: 5.5, setsB: 0.5, gamesA: 39, gamesB: 9 },
  "7-2": { setsA: 4, setsB: 2, gamesA: 27, gamesB: 21 },
  "7-3": { setsA: 5.5, setsB: 0.5, gamesA: 41, gamesB: 7 },
  "8-0": { setsA: 3.5, setsB: 2.5, gamesA: 24, gamesB: 24 },
  "8-1": { setsA: 4, setsB: 2, gamesA: 33, gamesB: 15 },
  "8-2": { setsA: 4, setsB: 2, gamesA: 33, gamesB: 15 },
  "8-3": { setsA: 3, setsB: 3, gamesA: 25, gamesB: 23 },
  "9-0": { setsA: 2.5, setsB: 3.5, gamesA: 20, gamesB: 28 },
  "9-1": { setsA: 1.5, setsB: 4.5, gamesA: 18, gamesB: 30 },
  "9-2": { setsA: 1.5, setsB: 4.5, gamesA: 16, gamesB: 32 },
  "9-3": { setsA: 2.5, setsB: 3.5, gamesA: 20, gamesB: 28 },
  "10-0": { setsA: 3, setsB: 3, gamesA: 18, gamesB: 30 },
  "10-1": { setsA: 3, setsB: 3, gamesA: 23, gamesB: 25 },
  "10-2": { setsA: 2, setsB: 4, gamesA: 18, gamesB: 30 },
  "10-3": { setsA: 0, setsB: 6, gamesA: 8, gamesB: 40 },
  "11-0": { setsA: 6, setsB: 0, gamesA: 33, gamesB: 15 },
  "11-1": { setsA: 3, setsB: 3, gamesA: 29, gamesB: 19 },
  "11-2": { setsA: 2, setsB: 4, gamesA: 12, gamesB: 36 },
  "11-3": { setsA: 1.5, setsB: 4.5, gamesA: 15, gamesB: 33 },
  "12-0": { setsA: 3.5, setsB: 2.5, gamesA: 26, gamesB: 22 },
  "12-1": { setsA: 0.5, setsB: 5.5, gamesA: 7, gamesB: 41 },
  "12-2": { setsA: 0, setsB: 6, gamesA: 9, gamesB: 39 },
  "12-3": { setsA: 5.5, setsB: 0.5, gamesA: 40, gamesB: 8 },
  "13-0": { setsA: 2, setsB: 4, gamesA: 14, gamesB: 34 },
  "13-1": { setsA: 4, setsB: 2, gamesA: 29, gamesB: 19 },
  "13-2": { setsA: 5, setsB: 1, gamesA: 31, gamesB: 17 },
  "13-3": { setsA: 3, setsB: 3, gamesA: 24, gamesB: 24 },
  "14-0": { setsA: 3, setsB: 3, gamesA: 24, gamesB: 24 },
  "14-1": { setsA: 3.5, setsB: 2.5, gamesA: 26, gamesB: 22 },
  "14-2": { setsA: 3.5, setsB: 2.5, gamesA: 29, gamesB: 19 },
  "14-3": { setsA: 2, setsB: 4, gamesA: 23, gamesB: 25 },
};
...
const FINALS_RESULTS = {
  ...
  // Finals use 8 sets/64 games per match (4-player roster), not 6/48.
  game1: { setsA: 4.5, setsB: 3.5, gamesA: 37, gamesB: 27, winner: 'A' },
  game2: { setsA: 4, setsB: 4, gamesA: 33, gamesB: 31, winner: 'A' },
  game3: { setsA: 4, setsB: 4, gamesA: 32, gamesB: 32, winner: 'A' },
  semi1: { setsA: 5, setsB: 3, gamesA: 39, gamesB: 25, winner: 'A' },
  semi2: { setsA: 5.5, setsB: 2.5, gamesA: 40, gamesB: 24, winner: 'A' },
  final: { setsA: 4, setsB: 4, gamesA: 33, gamesB: 31, winner: 'A' },
};
