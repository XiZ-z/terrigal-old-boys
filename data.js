...
const WET_ROUNDS = {
  // Sample data for poc preview only -- shows all three states (first
...
const FINALS_WET_WEEKS = {
  // Sample data for poc preview only -- demonstrates the "pushed back a
...
const RESULTS = {
  // Sample data for poc preview only -- rounds 1-3. Cleared before the real season.
...
const FINALS_RESULTS = {
  // Sample data for poc preview only -- pretends Games 1-3 and Semi 1 have
